...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { attendee_id: @invitation.attendee_id, is_organizer: @invitation.is_organizer, meeting_id: @invitation.meeting_id } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { attendee_id: @invitation.attendee_id, is_organizer: @invitation.is_organizer, meeting_id: @invitation.meeting_id } }
